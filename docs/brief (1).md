...
- Le **risque individuel** = score de compétence^1.5 × fonction du delta (s'emballe au-delà d'un seuil défini, ex. +30 min)
...
**Score^1.5** — Le score de compétence est élevé à la puissance 1.5 avant multiplication par f(delta), pour amplifier l'écart entre profils rares et profils courants. Limite connue : un delta très élevé sur un profil faible peut dépasser un profil critique modérément impacté. À signaler aux RH : lire le tableau avec le score de compétence, pas seulement le risque individuel.
